...
ng g library global --buildable --directory=shared --importPath=@ab/global --tags='shared, core'
...
ng g library data --buildable --directory=shared --importPath=@ab/data  --tags='shared, core'
...
ng g library ui --buildable --directory=shared --importPath=@ab/ui --prefix=ab-ui  --tags='shared, ui'
...
ng g library form --buildable --directory=shared --importPath=@ab/form --prefix=ab-form  --tags='shared, ui'
...
ng g library layout --buildable --directory=shared --importPath=@ab/layout --prefix=ab --tags='shared, ui'
