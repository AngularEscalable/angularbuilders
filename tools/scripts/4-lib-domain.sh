...
ng g interface models/category --domain-home
git add *
...
ng g interface models/resource --domain-resource
...
ng g interface models/category --domain-category
ng g interface models/resource --domain-category
...
ng g interface models/category --domain-resource-new
ng g interface models/resource --domain-resource-new
git add *
